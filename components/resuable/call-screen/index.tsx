...
export default function CallScreen({
  ...
  return (
    <div className="relative flex flex-col md:flex-row w-full h-full gap-4">
      <animations.FadeSlide className="flex-auto h-full">
      ...
      <animations.FadeSlide className=" md:w-[500px] w-full h-full">
        <Card className="rounded-2xl md:w-[500px] w-full md:h-full border-muted shadow-xl">
